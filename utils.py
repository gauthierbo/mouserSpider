...
def selectUserAgent():
    N = len(userAgents)
    return userAgents[randint(0,N-1)]

#代理池
proxiesPool = [
    {'socks5':'167.71.249.173:10801'},
    {'http':'199.60.103.227:80'},
    {'socks4':'72.221.196.145:4145'},
    {'socks4':'177.54.228.147:5678'},
    {'socks4':'81.162.119.138:5678'},
    {'http':'202.212.123.44:80'},
    {'http':'202.212.123.44:80'}
]
def selectProxy():
    N = len(proxiesPool)
    return proxiesPool[randint(0,N-1)]
